...
const Registration = () => {
  ...
  const handleStepsInputs = email ? step2Inputs : step1Inputs
  ...
  useEffect(() => {
    if (data !== null) {
      ...
      [
        alert(
          `Não foi possivel realizar a operação. Entra em contato com nosso suporte (${error}).`
        ),
      ]
  }, [data, error, navigate])
        ...
        <Grid container>
          ...
          >
            <Container maxWidth="sm">
              ...
              <Box sx={{ marginBottom: pxToRem(24) }}>
                ...
                {email && (
                  <StyledUl>
                    ...
                    <li>Pelo menos uma letra maiúcula;</li>
              ...
              <FormComponent
                inputs={handleStepsInputs.map((input, index) => ({
                  type: input.type,
